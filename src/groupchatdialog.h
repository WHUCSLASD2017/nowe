...
public:
    ...
    static QMap<QString,GroupChatDialog *> openedDialogs;
    QString bareJid;
    static GroupChatDialog *getChatDialog(QString bareJid, QString username, QString signature, QString receiver, QPixmap avatar);
